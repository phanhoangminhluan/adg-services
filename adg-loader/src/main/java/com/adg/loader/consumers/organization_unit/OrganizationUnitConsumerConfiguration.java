...
@Configuration
@EnableKafka
public class OrganizationUnitConsumerConfiguration extends AbstractConsumerConfiguration {
    @Override
    protected String getGroupId() {
        return PubSubConstants.OrganizationUnit.GROUP_ID;
    }

    @Override
    @Bean(value = PubSubConstants.OrganizationUnit.CONSUMER_FACTORY)
    protected ConsumerFactory<String, String> consumerFactory() {
        return super.consumerFactory();
    }

    @Override
    @Bean(value = PubSubConstants.OrganizationUnit.LISTENER_CONTAINER_FACTORY)
