...
@Configuration
@EnableKafka
public class SaleOrderConsumerConfiguration extends AbstractConsumerConfiguration {
    @Override
    protected String getGroupId() {
        return PubSubConstants.Order.GROUP_ID;
    }

    @Override
    @Bean(value = PubSubConstants.Order.CONSUMER_FACTORY)
    protected ConsumerFactory<String, String> consumerFactory() {
        return super.consumerFactory();
    }

    @Override
    @Bean(value = PubSubConstants.Order.LISTENER_CONTAINER_FACTORY)
